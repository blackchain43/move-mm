...
const Task = () => {
  ...
  const {
    ...
    ["systemService.fetchTask", { requestor: wallet?.address || "" }],
    ({ queryKey }) => {
                  ...
                  columns={[
                    ...
                    },
                    {
                      ...
                      render: (value) => (
                        ...
                        >
                          {formatMoney(
                            Web3.utils.fromWei(value, TOKENS[1].format)
                          )}
                        </span>
                      ),
                    },
                    {
                      ...
                      render: (value) => (
                        ...
                        >
                          {formatMoney(
                            Web3.utils.fromWei(value, TOKENS[0].format)
                          )}
                        </span>
                      ),
                    },
                    {
                      ...
                      render: (value) => (
                        <span>
                          {formatMoney(Web3.utils.fromWei(value, "Gwei"))}
                        </span>
                      ),
                    },
                  ]}
